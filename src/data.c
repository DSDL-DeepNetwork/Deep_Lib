...
입력 / **paths : 경로가 저장된 주소
n : 경로의 수(?)
*find : 경로에서 특정 text 찾기 (ex. .png, .jpg)
*replace : 경로에서 찾은 text를 변경시킬 string
출력 / repace_paths :해당경로에서  변경시킨 text로 반환
기능 / 다수의 경로에서 file labeling
***************************************************************/
